...
export default function FirebaseConfigPage() {
  ...
  const [activeSection, setActiveSection] = useState<"config" | "features" | "status" | "deploy">("config")
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="flex flex-wrap justify-center gap-2 mb-6">
        <Button variant={activeSection === "config" ? "default" : "outline"} onClick={() => setActiveSection("config")}>
          Configuration
        </Button>
        <Button
        ...
        <Button variant={activeSection === "status" ? "default" : "outline"} onClick={() => setActiveSection("status")}>
          Status
        </Button>
        <Button variant={activeSection === "deploy" ? "default" : "outline"} onClick={() => setActiveSection("deploy")}>
          Deploy
        </Button>
      </div>
          ...
          <CardContent className="space-y-6">
            ...
            <Alert className="border-green-200 bg-green-50">
              ...
              <AlertDescription className="text-green-800">
                ...
                Use the export options above to integrate with your deployment pipeline.
              </AlertDescription>
            </Alert>
